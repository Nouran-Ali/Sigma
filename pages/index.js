        ...
        <div className='grid grid-cols-2 gap-4 '>
          ...
          <div className='mt-28'>
            <div className={`${styles.animation} pr-3`}>
              ...
              <p className='text-[#909191] leading-relaxed mt-4 mb-8 w-96 max-md:w-full'>Sigma is a progressive architectural practice providing high-quality architectural and construction services for the domestic, industrial, and commercial sectors.</p>
              <Link href="/about" className='' style={{ backgroundColor: "#384e4c10", color: "#7a9595", border: "1px solid #384e4c3b", borderRadius: "20px", paddingLeft: "20px", paddingRight: "20px", paddingBottom: "10px", paddingTop: "10px" }}>
                Read more
                <img src='../star.png' width='25px' height="10px" className={`ml-3 inline-block`} />
              </Link>
              <div className=''>
