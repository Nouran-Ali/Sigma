...
const services = () => {
    ...
    return (
        <div className='2xl:flex mt-9'>
            ...
            <div className='bg-[#e8e8e8] rounded-[80px] w-9/12 max-xl:w-full h-80 max-xl:h-full pl-20 max-xl:pl-5 p-10 max-xl:p-5 ml-auto max-xl:ml-0 2xl:mr-5 max-xl:mt-52'>
