    ...
    <div dir={language == "ar" ? "rtl" : "ltr"}>
      <Breadcrumb
        ...
        items={[
          ...
          {
            title: t("Private_sports_club_project"),
          },
        ]}
      />
      <div className='mb-7'>
      ...
      <div className='grid grid-cols-2 max-md:grid-cols-1 gap-4'>
        <div>
          <h1 className='text-2xl'>{t("all_project.title_sports")}</h1>
...
export default Private_sports_club
